...
-- This stored procedure calculates the cost of electricity as charged by
-- Puget Sound Electricity (PSE) between and including two days.  This
-- procedure allows the user to get the expected cost of electricity before
-- a monthly PSE bill is created.
